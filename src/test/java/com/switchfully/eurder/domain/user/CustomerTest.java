...
class CustomerTest {
    ...
    void whenCreatingCustomerWithNullFirstName_thenThrowIllegalArgumentException() {
        assertThrows(IllegalArgumentException.class, () -> new Customer(null, "f", "f@f.f","f", "f", "f"));
    }

    @Test
    void whenCreatingCustomerWithBlankFirstName_thenThrowIllegalArgumentException() {
        assertThrows(IllegalArgumentException.class, () -> new Customer("", "f", "f@f.f","f", "f", "f"));
    }

    @Test
    void whenCreatingCustomerWithNullLastName_thenThrowIllegalArgumentException() {
        assertThrows(IllegalArgumentException.class, () -> new Customer("F", null, "f@f.f","f", "f", "f"));
    }
    ...
    void whenCreatingCustomerWithNullEmail_thenThrowIllegalEmailException() {
        assertThrows(IllegalEmailException.class, () -> new Customer("F", "f", null, "f","f", "f"));
    }
    ...
    void whenCreatingCustomerWithInvalidEmail_thenThrowIllegalEmailException() {
        assertThrows(IllegalEmailException.class, () -> new Customer("F", "f", "f", "f","f", "f"));
    }

    @Test
    void whenCreatingCustomerWithNullAddress_thenThrowIllegalArgumentException() {
        assertThrows(IllegalArgumentException.class, () -> new Customer("F", "f", "f@f.f","f", null, "f"));
    }
    ...
    void whenCreatingCustomerWithNullPhonenumber_thenThrowIllegalArgumentException() {
        assertThrows(IllegalArgumentException.class, () -> new Customer("F", "f", "f@f.f","f", "f", null));
    }
    ...
    void whenCreatingValidCustomer_thenThrowNoException() {
        assertDoesNotThrow(() -> new Customer("F", "f", "f@f.f","f", "f", "F"));
    }
