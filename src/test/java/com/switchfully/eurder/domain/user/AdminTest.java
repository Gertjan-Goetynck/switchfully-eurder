...
class AdminTest {
    ...
    void whenCreatingAdminWithNullFirstName_thenThrowIllegalArgumentException() {
        assertThrows(IllegalArgumentException.class, () -> new Admin(null, "f", "f@f.f","f", "f", "f"));
    }

    @Test
    void whenCreatingAdminWithBlankFirstName_thenThrowIllegalArgumentException() {
        assertThrows(IllegalArgumentException.class, () -> new Admin("", "f", "f@f.f","f", "f", "f"));
    }

    @Test
    void whenCreatingAdminWithNullLastName_thenThrowIllegalArgumentException() {
        assertThrows(IllegalArgumentException.class, () -> new Admin("F", null, "f@f.f","f", "f", "f"));
    }
    ...
    void whenCreatingAdminWithNullEmail_thenThrowIllegalEmailException() {
        assertThrows(IllegalEmailException.class, () -> new Admin("F", "f", null, "f","f", "f"));
    }
    ...
    void whenCreatingAdminWithInvalidEmail_thenThrowIllegalEmailException() {
        assertThrows(IllegalEmailException.class, () -> new Admin("F", "f", "f","f","f", "f"));
    }

    @Test
    void whenCreatingAdminWithNullAddress_thenThrowIllegalArgumentException() {
        assertThrows(IllegalArgumentException.class, () -> new Admin("F", "f", "f@f.f","f", null, "f"));
    }
    ...
    void whenCreatingAdminWithNullPhonenumber_thenThrowIllegalArgumentException() {
        assertThrows(IllegalArgumentException.class, () -> new Admin("F", "f", "f@f.f","f", "f", null));
    }
    ...
    void whenCreatingValidAdmin_thenThrowNoException() {
        assertDoesNotThrow(() -> new Admin("F", "f", "f@f.f","f", "f", "F"));
    }

    @Test
    void whenCreatingValidAdmin_thenUserRoleIsAdmin() {
        //WHEN
        Admin admin = new Admin("F", "f", "f@f.f","f", "f", "F");
